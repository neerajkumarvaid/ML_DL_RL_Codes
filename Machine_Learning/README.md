...
|8 | [Parameter-Distribution.ipynb](https://github.com/neerajkumarvaid/ML_DL_RL_Codes/blob/master/Machine_Learning/Parameter-Distribution.ipynb) | Illustrates how posterior distribution changes with additional number of training point for Bayesian Linear Regression (Ref. Section 3.3.1 Bishop).|
